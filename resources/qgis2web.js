...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-11818766.059218, 3331910.390430, -11818138.597170, 3332328.085909],
            units: 'm'
        })
    })
});
...
map.getView().fit([-11818874.023652, 3331918.716713, -11818230.476330, 3332367.826093], map.getSize());
